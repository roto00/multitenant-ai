# Alternative EC2-based deployment for cost optimization
# This approach eliminates NAT Gateway costs and uses ARM64 Graviton instances

# Launch Template for ARM64 Graviton instances
resource "aws_launch_template" "app" {
  name_prefix   = "${var.project_name}-app-"
  image_id      = data.aws_ami.amazon_linux_arm64.id
  instance_type = "t4g.medium"  # ARM64 Graviton - 20-40% cheaper than x86
